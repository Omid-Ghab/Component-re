...
def show_help():
    distName = st.session_state.distName_help

    
    if distName == 'What dose this tool do?': 
           st.write('AAAAAAAAAA')

        
    elif distName == 'How to work with  Reliability Plots tab?':
            st.write('BBBBB')

    elif distName == 'How to work with  Reliability  tab?':
            st.write('BBBBB')

    elif distName == 'How to work with  Time To Failure tab? ':
            st.write('BBBBB')
...
tab_plots, tab_reliability, tab_ttf, tab_dfit, tab_help = st.sidebar.tabs(['Reliability Plots and Stat.', 'Reliability','Time to Failure', 'Distribution Fitter', 'Help'])
...
with tab_help:
    st.header('System Reliability Engineering Calcutaion Help')
    d = st.radio('Help Subjects:', ['What dose this tool do?' ,
             'How to work with  Reliability Plots tab?',
             'How to work with Reliability tab?',
             'How to work with Time To Failure tab?'], on_change=show_help, key='distName_help')